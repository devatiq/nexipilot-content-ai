...
(function() {
    ...
    function initFAQAccordion() {
        const faqContainer = document.querySelector('.postpilot-faq--accordion');
        
        if (!faqContainer) {
            return;
        }

        const faqItems = faqContainer.querySelectorAll('.postpilot-faq__item');
        
        faqItems.forEach(function(item, index) {
            const question = item.querySelector('.postpilot-faq__question');
            const answer = item.querySelector('.postpilot-faq__answer');
            ...
            // Set unique IDs
            const answerId = 'postpilot-faq-answer-' + index;
            answer.id = answerId;
    ...
    function toggleAccordion(item, question, answer) {
        ...
        const faqContainer = item.closest('.postpilot-faq--accordion');
    ...
    function closeAllAccordions(container) {
        const allItems = container.querySelectorAll('.postpilot-faq__item');
