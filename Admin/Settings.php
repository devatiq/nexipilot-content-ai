    ...
    public function render_settings_page()
    {
        ...
        <div class="wrap postpilot-settings-wrap" <?php echo $settings_updated ? 'data-settings-saved="true"' : ''; ?>>
                ...
                <div class="postpilot-header-content">
                    <div class="postpilot-header-title">
                        ...
                        <div>
                            ...
                            <p class="postpilot-subtitle">
                                <?php esc_html_e('AI-Powered Content Enhancement for WordPress', 'postpilot'); ?></p>
                        </div>
                    </div>
                    <div class="postpilot-header-actions">
                        ...
                        <span class="postpilot-status-badge <?php echo esc_attr($status_class); ?>" id="postpilot-api-status"
                            <?php if (!empty($error_details)): ?>title="<?php echo esc_attr($error_details); ?>" <?php endif; ?>>
                            <span class="status-dot"></span>
                            <?php echo esc_html($status_text); ?>
                            <?php if (!empty($error_details)): ?>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                    style="margin-left: 4px; vertical-align: middle; opacity: 0.7;">
            ...
            <div class="postpilot-tabs">
                ...
                <button type="button" class="postpilot-tab" data-tab="feature-settings">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <?php esc_html_e('Feature AI Settings', 'postpilot'); ?>
                </button>
                            ...
                            <div class="postpilot-card-body">
                                ...
                                <div class="postpilot-field-group postpilot-api-key-field" id="openai-api-key-field">
                                    ...
                                    <div class="postpilot-input-group">
                                        ...
                                        ?>
                                        <input type="password" name="postpilot_openai_api_key" id="postpilot_openai_api_key"
                                            class="postpilot-input" value="<?php echo esc_attr($openai_key_decrypted); ?>"
                                            placeholder="sk-..." />
                                ...
                                <div class="postpilot-field-group postpilot-api-key-field" id="claude-api-key-field"
                                    style="display: none;">
                                    ...
                                    <div class="postpilot-input-group">
                                        ...
                                        ?>
                                        <input type="password" name="postpilot_claude_api_key" id="postpilot_claude_api_key"
                                            class="postpilot-input" value="<?php echo esc_attr($claude_key_decrypted); ?>"
                                            placeholder="sk-ant-..." />
                                ...
                                <div class="postpilot-field-group postpilot-api-key-field" id="gemini-api-key-field"
                                    style="display: none;">
                                    ...
                                    <div class="postpilot-input-group">
                                        ...
                                        ?>
                                        <input type="password" name="postpilot_gemini_api_key" id="postpilot_gemini_api_key"
                                            class="postpilot-input" value="<?php echo esc_attr($gemini_key_decrypted); ?>"
                                            placeholder="AIza..." />
                                    ...
                                    <p class="postpilot-field-description">
                                        <?php esc_html_e('Get your API key from', 'postpilot'); ?>
                                        <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener">Google
                                            AI Studio</a>
                                    </p>
                                </div>
                            ...
                            <div class="postpilot-card-body">
                                ...
                                <div class="postpilot-field-group">
                                    ...
                                    <select name="postpilot_gemini_model" id="postpilot_gemini_model_providers"
                                        class="postpilot-select">
                                        <option value="gemini-2.0-flash-exp" <?php selected(get_option('postpilot_gemini_model', 'gemini-2.0-flash-exp'), 'gemini-2.0-flash-exp'); ?>>
                                            Gemini 2.0 Flash (Experimental)
                                        </option>
                                        <option value="gemini-1.5-pro" <?php selected(get_option('postpilot_gemini_model'), 'gemini-1.5-pro'); ?>>
                                            Gemini 1.5 Pro
                                        </option>
                                        <option value="gemini-1.5-flash" <?php selected(get_option('postpilot_gemini_model'), 'gemini-1.5-flash'); ?>>
                                            Gemini 1.5 Flash
                                        </option>
                                    </select>
                                    <p class="postpilot-field-description">
