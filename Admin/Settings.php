...
class Settings
{
    ...
    public function validate_openai_key($old_value, $new_value)
    {
        ...
        $openai = new \PostPilot\AI\OpenAI($new_value);
        $result = $openai->validate_api_key($new_value);
    ...
    public function validate_claude_key($old_value, $new_value)
    {
        ...
        $claude = new \PostPilot\AI\Claude($new_value);
        $result = $claude->validate_api_key($new_value);
    ...
    public function validate_gemini_key($old_value, $new_value)
    {
        ...
        $gemini = new \PostPilot\AI\Gemini($new_value);
        $result = $gemini->validate_api_key($new_value);
