                                            ...
                                            <div class="postpilot-settings-grid">
                                                ...
                                                <div class="postpilot-card postpilot-provider-card">
                                                    <div class="postpilot-card-header">
                                                        ...
                                                        <div>
                                                            <h2><?php esc_html_e('xAI Grok', 'postpilot'); ?></h2>
                                                            <p><?php esc_html_e('Configure Grok API credentials and model selection', 'postpilot'); ?>
                                                            </p>
                                                        </div>
                                                        <?php
                                            ...
                                            <div class="postpilot-settings-grid">
                                                ...
                                                <div class="postpilot-card">
                                                    ...
                                                    <div class="postpilot-card-body">
                                                        <div class="postpilot-field-group">
                                                            ...
                                                            <?php
                                                            // DEBUG: Show what providers we have
                                                            $debug_providers = $this->get_available_providers();
                                                            echo '<!-- DEBUG FAQ PROVIDERS: ' . print_r($debug_providers, true) . ' -->';
                                                            ?>
                                                            <select name="postpilot_faq_provider" id="postpilot_faq_provider" class="postpilot-select">
                                                                ...
                                                                foreach ($this->get_available_providers() as $key => $name):
                                                                    ?>
                                                                                <option value="<?php echo esc_attr($key); ?>" <?php selected($faq_provider, $key); ?>>
                                                    ...
                                                    <div class="postpilot-card-body">
                                                        <div class="postpilot-field-group">
                                                            ...
                                                            <select name="postpilot_summary_provider" id="postpilot_summary_provider"
                                                                ...
                                                                foreach ($this->get_available_providers() as $key => $name):
                                                                    ?>
                                                                                <option value="<?php echo esc_attr($key); ?>" <?php selected($summary_provider, $key); ?>>
                                                                                    <?php echo esc_html($name); ?>
                                                                                </option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                    ...
                                                    <div class="postpilot-card-body">
                                                        <div class="postpilot-field-group">
                                                            ...
                                                            <select name="postpilot_internal_links_provider" id="postpilot_internal_links_provider"
                                                                class="postpilot-select">
                                                                <?php
                                                                $internal_links_provider = get_option('postpilot_internal_links_provider', 'openai');
                                                                foreach ($this->get_available_providers() as $key => $name):
                                                                    ?>
                                                                                <option value="<?php echo esc_attr($key); ?>" <?php selected($internal_links_provider, $key); ?>>
                                                                                    <?php echo esc_html($name); ?>
                                                                                </option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                ...
                                                <div class="postpilot-card">
                                                    <div class="postpilot-card-header">
                                                        ...
                                                        <div>
                                                            <h2><?php esc_html_e('External AI Sharing', 'postpilot'); ?></h2>
                                                            <p><?php esc_html_e('Allow readers to summarize posts with external AI tools', 'postpilot'); ?></p>
                                                        </div>
                                                    ...
                                                    <div class="postpilot-card-body" id="external-ai-sharing-options">
                                                        <div class="postpilot-field-group">
                                                            <label for="postpilot_external_ai_position" class="postpilot-label">
                                                                <?php esc_html_e('Display Position', 'postpilot'); ?>
                                                            </label>
                                                            <select name="postpilot_external_ai_position" id="postpilot_external_ai_position" class="postpilot-select">
                                                            ...
                                                            <p class="postpilot-field-description">
                                                                <?php esc_html_e('Choose where to display the external AI sharing buttons', 'postpilot'); ?>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="postpilot-field-group">
                                                            ...
                                                            <div class="postpilot-checkbox-group">
                                                                ...
                                                                <label class="postpilot-checkbox-label">
                                                                    <input type="checkbox" name="postpilot_external_ai_perplexity" value="1" <?php checked(get_option('postpilot_external_ai_perplexity', '1'), '1'); ?> />
                                                        ...
                                                        <div class="postpilot-feature-item">
                                                            ...
                                                            <div class="postpilot-feature-options" id="external-ai-sharing-options">
                                                                <div class="postpilot-field-group">
                                                                    ...
                                                                    <select name="postpilot_external_ai_position" id="postpilot_external_ai_position" class="postpilot-select-small">
                                                                        <option value="before_content" <?php selected(get_option('postpilot_external_ai_position', 'after_content'), 'before_content'); ?>>
                                                                            <?php esc_html_e('Before Content', 'postpilot'); ?>
                                                                        </option>
                                                                        <option value="after_content" <?php selected(get_option('postpilot_external_ai_position', 'after_content'), 'after_content'); ?>>
